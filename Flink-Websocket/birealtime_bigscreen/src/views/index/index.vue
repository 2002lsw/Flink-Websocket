...
<template>
  <div class="index-box">
    ...
    <div class="contetn_center">
      ...
      <ItemWrap class="contetn_center-bottom" title="用户实时分析">
        <CenterBottom />
      </ItemWrap>
    </div>
    <div class="contetn_right">
      <ItemWrap class="contetn_left-bottom contetn_lr-item" title="实时订单">
        <RightTop />
      </ItemWrap>
      <ItemWrap
        class="contetn_left-bottom contetn_lr-item"
      ...
      <ItemWrap class="contetn_left-bottom contetn_lr-item" title="实时用户日志 ">
        <RightBottom />
      </ItemWrap>
    </div>
  </div>
